...
var adminurl = "https://doctor-scheduling-system-production.up.railway.app/springbootjf5zc/admin/dist/index.html";
...
var menu = [{
    ...
    "frontMenu": [{
        ...
        "child": [{"buttons": ["查看"], "menu": "医护信息列表", "menuJump": "列表", "tableName": "yihuxinxi"}],
        "menu": "医护信息模块"
    }, {
        "child": [{
            "buttons": ["查看", "查看评论"],
        ...
        "child": [{"buttons": ["查看"], "menu": "投诉信息列表", "menuJump": "列表", "tableName": "tousuxinxi"}],
        "menu": "投诉信息模块"
    }],
    "hasBackLogin": "是",
    "hasBackRegister": "否",
