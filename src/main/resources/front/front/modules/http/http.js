layui.define(['jquery', 'layer'], function (exports) { //提示：模块也可以依赖其它模块，如：layui.define('layer', callback);
    ...
    var jquery = layui.jquery,
        layer = layui.layer,
        baseurl = "https://doctor-scheduling-system-production.up.railway.app/springbootjf5zc/";
    var http = {
        domain: "https://doctor-scheduling-system-production.up.railway.app/springbootjf5zc/",
        baseurl: baseurl,
        /**
         * 获取传递参数值(修改支持中文)
         */
